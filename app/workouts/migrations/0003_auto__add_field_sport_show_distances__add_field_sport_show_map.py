...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sport.show_distances'
        db.add_column(u'workouts_sport', 'show_distances',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Sport.show_map'
        db.add_column(u'workouts_sport', 'show_map',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sport.show_distances'
        db.delete_column(u'workouts_sport', 'show_distances')

        # Deleting field 'Sport.show_map'
        db.delete_column(u'workouts_sport', 'show_map')
