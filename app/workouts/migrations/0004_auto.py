...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field only_for on 'Distance'
        m2m_table_name = db.shorten_name(u'workouts_distance_only_for')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('distance', models.ForeignKey(orm[u'workouts.distance'], null=False)),
            ('sport', models.ForeignKey(orm[u'workouts.sport'], null=False))
        ))
        db.create_unique(m2m_table_name, ['distance_id', 'sport_id'])


    def backwards(self, orm):
        # Removing M2M table for field only_for on 'Distance'
        db.delete_table(db.shorten_name(u'workouts_distance_only_for'))
