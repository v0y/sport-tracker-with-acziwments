...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Workout.notes'
        db.alter_column(u'workouts_workout', 'notes', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Workout.notes'
        raise RuntimeError("Cannot reverse this migration. 'Workout.notes' and its values cannot be restored.")
