...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Workout.name'
        db.alter_column(u'workouts_workout', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Workout.name'
        db.alter_column(u'workouts_workout', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=64))
