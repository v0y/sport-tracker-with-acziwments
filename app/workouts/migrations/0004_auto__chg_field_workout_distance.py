...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Workout.distance'
        db.alter_column(u'workouts_workout', 'distance', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Workout.distance'
        db.alter_column(u'workouts_workout', 'distance', self.gf('django.db.models.fields.FloatField')(default=''))
