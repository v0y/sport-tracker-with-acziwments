...
(function() {
  ...
  MapHandler = (function() {
    ...
    MapHandler.prototype.mode = 'readOnly';
    ...
    MapHandler.prototype.initializeMap = function() {
      ...
      if (!this.map) {
        ...
        return this.map = new google.maps.Map($(".js-map-canvas")[0], mapOptions);
      }
    };
  ...
  Route = (function() {
    ...
    Route.prototype.addStartFinishMarkers = function() {
      ...
      google.maps.event.addListener(this.startMarker, 'click', (function(_this) {
        return function() {
          finishInfoWindow.close();
          return startInfoWindow.open(_this.map, _this.startMarker);
        };
      })(this));
      return google.maps.event.addListener(this.finishMarker, 'click', (function(_this) {
        return function() {
    ...
    Route.prototype.drawFullKmMarkers = function(fullKmSectionsList) {
      var i, image, km, kmsToMark, lat, latlng, lon, marker, markerCounter, pt1ToFullKmDistance, section, start, _i, _len, _results;
      markerCounter = 1;
      _results = [];
