...
(function() {
  var ManualRouteHandler, MapHandler, Route, deg2rad, get2MarkersDistance, get2PointsDistance, getDistanceFromLatLonInKm, getPointOnSection, getPointToMarkerDistance, getPositionOnShortestPath, getTotalDistance;
  ...
  get2MarkersDistance = function(mark1, mark2) {
    var pt1, pt2;
    pt1 = {
      'lat': mark1.position.lat(),
      'lon': mark1.position.lng()
    };
    pt2 = {
      'lat': mark2.position.lat(),
      'lon': mark2.position.lng()
    };
