...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'accounts', ['UserActivation'])

        # Adding model 'PasswordReset'
        db.create_table(u'accounts_passwordreset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='password_reset', unique=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'accounts', ['PasswordReset'])

        # Adding model 'EmailActivation'
        db.create_table(u'accounts_emailactivation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='email_activation', unique=True, to=orm['auth.User'])),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal(u'accounts', ['EmailActivation'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'accounts_passwordreset')

        # Deleting model 'EmailActivation'
        db.delete_table(u'accounts_emailactivation')


    models = {
        u'accounts.emailactivation': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'email_activation'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
        u'accounts.passwordreset': {
            'Meta': {'object_name': 'PasswordReset'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'password_reset'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
